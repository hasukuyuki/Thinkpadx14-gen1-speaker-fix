 ...
 *
 * Disassembly of SSDT29.aml
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x000051BC (20924)
 *     Revision         0x02
 *     Checksum         0xAF
 *     OEM ID           "LENOVO"
 ...
 */
DefinitionBlock ("", "SSDT", 2, "LENOVO", "I2C_DEVT", 0x00001000)
{
    ...
    External (TDFV, UnknownObj)
    External (TDPI, UnknownObj)
    External (TDVI, UnknownObj)
    External (TLPI, UnknownObj)
    External (TLVI, UnknownObj)
    ...
    Scope (\_SB.PC00.I2C0)
    {
        Device (TPD0)
        {
                ...
                While ((Local0 < Local1))
                {
                    ...
                    If ((TDVI == Local3))
                    {
                        If ((TDPI == Local4))
                        {
                            ...
                            If ((_HID == "SYNA8030"))
                            {
                                If (((\TDFV >= 0x1000) && (\TDFV < 0x2000)))
                                {
                                    _HID = "SYNA802F"
                                }

                                If (((\TDFV >= 0x0100) && (\TDFV < 0x0200)))
                                {
                                    _HID = "SYNA802F"
                                }
                            }

                            _HRV = \TDFV /* External reference */
                            If ((Local5 == Zero))
                            {
                                SPED = 0x000186A0
                            }
            ...
            Method (_DSM, 4, Serialized)  // _DSM: Device-Specific Method
            {
                If ((Arg0 == HIDG))
                {
                    Return (H0ID (Arg0, Arg1, Arg2, Arg3, HID2))
                }
    ...
    {
        /* 0000 */  0x01, 0x01, 0x97, 0x10, 0x1A, 0x00, 0x00, 0x00,  // ........
